...
const getRecentlyPlayed = async (req, res) => {
  ...
  try {
    ...
    const valenceSum = audioFeatures.reduce((sum, feature) => sum + feature.valence, 0);
    const danceabilitySum = audioFeatures.reduce((sum, feature) => sum + feature.danceability, 0);
    const energySum = audioFeatures.reduce((sum, feature) => sum + feature.energy, 0);
    ...
    let mood;
    if (averageValence > 0.7 && averageDanceability > 0.7 && averageEnergy > 0.7) {
      mood = 'Energetic';
    } else if (averageValence > 0.7 && averageDanceability > 0.7 && averageEnergy <= 0.7) {
      mood = 'Happy';
    } else if (averageValence > 0.7 && averageDanceability <= 0.7 && averageEnergy > 0.7) {
      mood = 'Excited';
    } else if (averageValence <= 0.7 && averageValence > 0.3 && averageDanceability <= 0.7 && averageEnergy <= 0.7) {
      mood = 'Content';
    } else if (averageValence > 0.3 && averageDanceability <= 0.5 && averageEnergy <= 0.5) {
      mood = 'Relaxed';
    } else if (averageValence > 0.3 && averageDanceability <= 0.5 && averageEnergy > 0.5) {
      mood = 'Calm';
    } else if (averageValence <= 0.3 && averageDanceability <= 0.3 && averageEnergy <= 0.3) {
      mood = 'Sad';
    } else if (averageValence <= 0.3 && averageDanceability > 0.5 && averageEnergy <= 0.5) {
      mood = 'Bored';
    } else if (averageValence <= 0.3 && averageDanceability <= 0.5 && averageEnergy > 0.5) {
